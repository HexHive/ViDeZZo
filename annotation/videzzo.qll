...
string getExprLiteral(Expr expr) {
  ...
  or
  result = expr.(FunctionCall).getTarget().getName() + "(" +
    getExprLiteral(expr.(FunctionCall).getArgument(0)) + ")" and expr.(FunctionCall).getNumberOfArguments() = 1
  or
  result = expr.(FunctionCall).getTarget().getName() + "(" +
    getExprLiteral(expr.(FunctionCall).getArgument(0)) + ", " +
    getExprLiteral(expr.(FunctionCall).getArgument(1)) + ")" and expr.(FunctionCall).getNumberOfArguments() = 2
  or
  result = expr.(FunctionCall).getTarget().getName() + "(" +
    getExprLiteral(expr.(FunctionCall).getArgument(0)) + ", " +
    getExprLiteral(expr.(FunctionCall).getArgument(1)) + ", " +
    getExprLiteral(expr.(FunctionCall).getArgument(2)) + ")" and expr.(FunctionCall).getNumberOfArguments() = 3
  or
  result = expr.(FunctionCall).getTarget().getName() + "(" +
    getExprLiteral(expr.(FunctionCall).getArgument(0)) + ", " +
    getExprLiteral(expr.(FunctionCall).getArgument(1)) + ", " +
...
Expr getDestination(Call call) {
  ...
  call instanceof FunctionCall
  or
  result = call.getArgument(getIndexOfDestinationArgument(call)) and
  call.(FunctionCall).getTarget().getName() != ["pci_dma_map"] and
  call.(FunctionCall).getTarget().getName() != ["dma_memory_map"] and
  call.(FunctionCall).getTarget().getName() != ["map_page"] and
  call instanceof FunctionCall
  or
  result = call.getArgument(getIndexOfDestinationArgument(call)) and call instanceof VariableCall
}
...
int getIndexOfDestinationArgument(Call call) {
  result = 1 and
...
predicate isSupportedFile(string pathname) {
  pathname = [
...
predicate isSupported(Call call) {
  isSupportedFile(call.getFile().getRelativePath())
}
